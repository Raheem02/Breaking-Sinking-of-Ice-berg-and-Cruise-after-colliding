...
#include<string.h>  
 ...
 { 
         ...
         glEnd(); 
         glColor3f(1,1,1); 
         bitmap_output(128,630,(char*)"                ",GLUT_BITMAP_TIMES_ROMAN_24); 
         glColor3f(1,1,1); 
         bitmap_output(138,590,(char*)"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING",GLUT_BITMAP_TIMES_ROMAN_24); 
         glColor3f(1,0,1); 
        bitmap_output(350,530,(char*)"A Mini Project On",GLUT_BITMAP_TIMES_ROMAN_24); 
         glColor3f(0.5,0.8,0); 
         bitmap_output(250,480,(char*)"Ship and Iceberg Collision",GLUT_BITMAP_TIMES_ROMAN_24); 
         glColor3f(1,0,1); 
         bitmap_output(100,420,(char*)"By",GLUT_BITMAP_TIMES_ROMAN_24); 
         glColor3f(1,0,0); 
        bitmap_output(100,370,(char*)"                         ",GLUT_BITMAP_TIMES_ROMAN_24); 
         glColor3f(1,0,0); 
         bitmap_output(100,330,(char*)"                 ",GLUT_BITMAP_TIMES_ROMAN_24);  
         glColor3f(1,0,1); 
         bitmap_output(350,240,(char*)"Guide",GLUT_BITMAP_TIMES_ROMAN_24);
         glColor3f(1,0,0); 
         bitmap_output(120,200,(char*)"                              ",GLUT_BITMAP_TIMES_ROMAN_24); 
        ...
        glEnd(); 
         glFlush(); 
         glColor3f(0,0,0); 
         bitmap_output(567,90,(char*)"Next",GLUT_BITMAP_TIMES_ROMAN_24); 
        glEnd(); 
         glFlush();
         glutSwapBuffers(); 
 } 
